...
public class SocialIconsDataSourceProvider implements CaConfigDatasourceProvider {

  public static final String NAME = "social-icons";
  ...
  public List<DataSourceOption> getOptions(ConfigurationBuilder configurationBuilder) {
    return Optional.ofNullable(configurationBuilder)
        .map(b -> b.as(SocialIconsConfig.class))
        .map(SocialIconsConfig::items)
