...
/** The Class RestrictRFPModifyToGSA. */
@Component(
    service = WorkflowProcess.class,
    property = {
      WorkflowConstants.PROCESS_LABEL + "=" + "Restrict modify for RFP process to GSA alone"
    })
@ServiceDescription("Restrict modify for RFP process to GSA alone")
@WorkflowCodeExcludeFromCodeCoverageReportGenerated
public class RestrictRFPModifyToGSA implements WorkflowProcess {

  @Reference ResourceResolverFactory resolverFactory;

  private static final Logger LOGGER = LoggerFactory.getLogger(RestrictRFPModifyToGSA.class);
