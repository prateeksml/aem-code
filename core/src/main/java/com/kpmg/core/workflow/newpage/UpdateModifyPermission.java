...
/** The Class UpdateModifyPermission. */
@Component(
    service = WorkflowProcess.class,
    property = {WorkflowConstants.PROCESS_LABEL + "=" + "Update Modify Permission on Live Copy"})
@ServiceDescription("A Modify permission workflow step")
@WorkflowCodeExcludeFromCodeCoverageReportGenerated
public class UpdateModifyPermission implements WorkflowProcess {

  @Reference ResourceResolverFactory resolverFactory;

  private static final Logger LOGGER = LoggerFactory.getLogger(UpdateModifyPermission.class);
