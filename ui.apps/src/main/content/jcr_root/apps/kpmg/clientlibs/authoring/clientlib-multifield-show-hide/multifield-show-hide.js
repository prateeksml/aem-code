 ...
 * How to use:
 *
 * - add the class multifield-cq-dialog-dropdown-showhide to the dropdown/select element
 * - add the data attribute multifield-cq-dialog-dropdown-showhide-target to the dropdown/select element, value should be the
...
(function (document, $) {
    ...
    $(document).on("foundation-contentloaded", function (e) {
        ...
        showHideHandler($(".multifield-cq-dialog-dropdown-showhide", e.target));
    });

    $(document).on("selected", ".multifield-cq-dialog-dropdown-showhide", function (e) {
    ...
    function showHide(component, dropdownEl) {
        var $dropdownEl = $(dropdownEl);
        var $scope = $dropdownEl.closest("coral-multifield-item"); // target search scope.

        // get the selector to find the target elements. its stored as data-.. attribute
        var target = $dropdownEl.data("multifieldCqDialogDropdownShowhideTarget");
