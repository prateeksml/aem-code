(function ($, channel, Coral) {
  ...
  var CHECKBOX_REQUIRED = ".cmp-form-options__required";
  const REQ_MSG_WRAPPER = '.cmp-form-options__requiredmessage';
  var REQUIREDMESSAGE_FIELD = ".cmp-form-options__requiredmessage_field";
  /**
